                ...
                <div class="lg:py5">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-5xl">
                            Get Relief From Pain<br><br> <span class="text-transparent font-bold text-5xl md:text-6xl lg:text-6xl bg-clip-text bg-gradient-to-r from-primary to-pink-500">
                                Dr. Chandra Shekhar Karmakar
                            </span>
                        </h1>
                    </div>
                    <p class="text-gray-300 pt-8 font-bold text-center lg:text-left mx-auto max-w-xl">
                        Assistant Professor, Dept. of Anaesthesia Analgesia & Intensive Care Medicine.
                     
                    </p>
                    <p class="text-gray-300 pt-0 text-center lg:text-left mx-auto max-w-xl">
                        Dr. Chandra Shekhar Karmakar has made notable contributions to enhancing pain management in Bangladesh through his dedicated research, clinical expertise, and commitment to improving patient care.
                    </p>
                ...
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary">
                            <img src="@/assets/chandra4.jpg" alt="Hero pic" width="500" height="auto" loading="lazy"
