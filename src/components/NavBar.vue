<template>
    <header class="flex justify-between items-center p-6 bg-opacity-50 relative z-20 ">
        <!-- <header class="flex justify-between items-center p-6 bg-opacity-50 relative z-20" style="background-color: dodgerblue;"> -->
        
        
            <!-- Logo section-->

        <!-- <div class="text-white text-3xl font-bold">LOGO</div> -->
        <div><img src="../assets/Chandra SK.svg" alt="Logo" class="h-12 w-auto"></div>
